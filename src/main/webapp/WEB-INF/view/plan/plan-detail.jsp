	...
	<div class="page no-navbar cached" data-name="todotaskDetailPage">
		<div class="page-content" style="padding-bottom: 30px;">
			...
			<div style="padding: 10px 10px 0px 10px;">
				<div style="margin-left:10px;margin-bottom: 5px;">
					<span style="font-weight: 600;">${planEntity.agencyCode }&nbsp;&nbsp;${planEntity.remark }</span><br>
					<span style="color: #949494;">${planEntity.menuName } / ${planEntity.createDate }</span>
				</div>
			</div>
			...
			<div class="card data-table data-table-collapsible data-table-init" style="padding-left: 10px;">
				...
				<div class="card-content">
					<div class="row no-gap" style="padding-top: 15px;">
						...
						<div class="col-70">${planEntity.planDetailCode }</div>
					</div>
					<div class="row no-gap" style="padding-top: 15px;">
					    <div class="col-30" style="font-weight: 600; font-size: 14px; color: #8e8e93;">申请日期:</div>
						<div class="col-70">${planEntity.createDate }</div>
					</div>
					<div class="row no-gap" style="padding-top: 15px;">
					    <div class="col-30" style="font-weight: 600; font-size: 14px; color: #8e8e93;">项目名称:</div>
						<div class="col-70">${planEntity.depProName }</div>
					</div>
					<div class="row no-gap" style="padding-top: 15px;">
					    <div class="col-30" style="font-weight: 600; font-size: 14px; color: #8e8e93;">资金性质:</div>
						<div class="col-70">${planEntity.fundType }</div>
					</div>
					<div class="row no-gap" style="padding-top: 15px;">
					    <div class="col-30" style="font-weight: 600; font-size: 14px; color: #8e8e93;">功能分类:</div>
						<div class="col-70">${planEntity.expFunc }</div>
					</div>
					<div class="row no-gap" style="padding-top: 15px;">
					    <div class="col-30" style="font-weight: 600; font-size: 14px; color: #8e8e93;">申请金额:</div>
						<div class="col-70">${planEntity.amount }</div>
					</div>
					<div class="row no-gap" style="padding-top: 15px;">
					    <div class="col-30" style="font-weight: 600; font-size: 14px; color: #8e8e93;">计划月份:</div>
						<div class="col-70">${planEntity.planMonth }</div>
					</div>
					<div class="row no-gap" style="padding-top: 15px;">
					    <div class="col-30" style="font-weight: 600; font-size: 14px; color: #8e8e93;">支付方式:</div>
						<div class="col-70">${planEntity.payType }</div>
					</div>
					<div class="row no-gap" style="padding-top: 15px;">
					    <div class="col-30" style="font-weight: 600; font-size: 14px; color: #8e8e93;">用途:</div>
						<div class="col-70">${planEntity.remark }</div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="toolbar tabbar tabbar-labels toolbar-bottom">
         	<div class="toolbar-inner">
				<a href="/toPlanSign/${planEntity.planId }/agree/${mobile}" class="tab-link tab-link-active">
					<i class="f7-icons">check</i>
					<span class="tabbar-label">同意</span>
				</a>
				<a href="/toPlanSign/${planEntity.planId }/back/${mobile}" class="tab-link tab-link-active">
